...
namespace ATMGO20MPOS.Models
{
    public partial class MPosTran
    {
        ...
        public string? CustAccRefNo { get; set; }
        public string? TransRefNo { get; set; }
        public string? RetrivalRefNo { get; set; }
        public string? Otp { get; set; }
        public string? PartnerCode { get; set; }
        public string? PartnerSessionId { get; set; }
        public string? AppResponseMsg { get; set; }
        public DateTime? AppResponseDateTime { get; set; }
        public string? PartnerMerchantId { get; set; }
        public string? ActualClwapirespCode { get; set; }
        public string? ClwqrExpiry { get; set; }
        public string? ClqqrHash { get; set; }
